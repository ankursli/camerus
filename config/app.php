...
return [
    ...
    */
    ...
    |
    */
    'url' => env('APP_URL', 'https://camerus.webstorm.fr/'),
    ...
    */
    'wp' => [
        'url' => env('WP_URL', 'https://camerus.webstorm.fr/cms'),
        'dir' => env('WP_DIR', 'cms')
    ],
    ...
    */
    'providers' => [
        ...
        App\Providers\ImportProductProvider::class,
    ...
    */
    'hooks' => [
        ...
        App\Hooks\Salon::class,
        App\Hooks\Product::class
    ],
    ...
    */
    'conditions' => [
        ...
        'is_checkout_pay_page' => 'checkout_pay_page'
    ]
];
