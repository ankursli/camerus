...
function load_yith_li_wishlist() {
    $license_options = get_option('yit_products_licence_activation', array());
    $license_options['yith-woocommerce-wishlist']['activated'] = true;
    $license_options['yith-woocommerce-wishlist']['email'] = 'email@email.com';
    $license_options['yith-woocommerce-wishlist']['licence_key'] = '****-****-****-************';
    $license_options['yith-woocommerce-wishlist']['activation_limit'] = '999';
    $license_options['yith-woocommerce-wishlist']['activation_remaining'] = '999';
    $license_options['yith-woocommerce-wishlist']['licence_expires'] = the_date();
...
add_action('init', 'load_yith_li_wishlist');
