...
function systempay_my_account_endpoint_content()
{
    ...
    $sub_module_saving_cards_ids = array('systempaystd', 'systempaysubscription', 'systempaywcssubscription');
...
{
    // Check if order was passed with one of systempay submodules.
    ...
    $order_refund_bean = new SystempayOrderInfo();
    ...
    $order_refund_bean->setOrderUserInfo(SystempayTools::get_user_info());
