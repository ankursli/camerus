...
function mtnc_reset_pass_url($lostpassword_url, $redirect)
{
    ...
    if(isset($mt_options['state']) && $mt_options['state'] === 0){
...
function mtnc_get_headers_503()
{
    ...
    if (!empty($mt_options['503_enabled'])) {
        ...
        if (isset($mt_options['state']) && $mt_options['state'] && !empty($mt_options['expiry_date_end']) && !empty($mt_options['expiry_time_end'])) {
