...
<div id="dialog-form-new-info" title="🚀 We're Rebuilding the Maintenance plugin! 🚀" style="display: none;">
  ...
  <div id="maintenance-options" class="wrap">
    ...
    if(isset($mt_option['state'])){
      $mt_option_state = $mt_option['state'];
    }
    ...
    <form method="post" action="" enctype="multipart/form-data" name="options-form">
      ...
      <div class="postbox-container header-container column-1 normal">
        <h1><img src="<?php echo esc_url(MTNC_URI); ?>images/wp-maintenance-logo.png" class="logo-image" title="Maintenance" alt="Maintenance"><p class="submit"><input type="checkbox" id="state" name="lib_options[state]" <?php checked($mt_option_state, 1); ?> /> <a href="<?php echo esc_url(home_url( '?maintenance-preview')); ?>" target="_blank" class="button">Preview</a> &nbsp;&nbsp; <input type="submit" name="submit" id="submit" class="button button-primary" value="Save Changes"></p></h1>
