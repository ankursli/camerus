...
registerBlockType('custom-gutenberg-elements/cge-content-bloc-type-2', {
    title: __('CGE: Content - Bloc type 2', 'custom-gutenberg-elements'),
    icon: 'index-card',
    category: 'formatting',
    attributes: {
        mediaId: {
        ...
        title: {
            type: 'string',
            source: 'html',
            selector: '.cge-content-bloc-type-2-title'
        },
    },
    edit: (props) => {
        const {
            ...
            <div className={className + ' cge-bloc-container'}>
                <div className="alert alert-info alert-yellow">
                    <div className="cge-bloc-title">
                        <span className="title">CGE: Content - Bloc Type 2</span>
                    </div>
                    <div className="row">
                            ...
                            <div className="form-row">
                                <div className="col">
                                    <div className="form-group">
                                        ...
                                        <RichText
                                            className="cge-content-bloc-type-2-title"
                                            tagName="h2"
    ...
    save: (props) => {
        ...
        return (
            <div className={"block block-content__type2 uk-width-1-1 " + className}>
                <div className="block-content uk-grid uk-grid-small">
                    ...
                    <div className="block-text uk-width-1-2@m">
                        <RichText.Content
                            className="cge-content-bloc-type-2-title title"
                            tagName="h2"
                            value={title}
                        />
