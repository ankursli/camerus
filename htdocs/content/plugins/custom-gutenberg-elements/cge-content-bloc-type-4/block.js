...
registerBlockType('custom-gutenberg-elements/cge-content-bloc-type-4', {
    title: __('CGE: Content - Bloc type 4', 'custom-gutenberg-elements'),
    icon: 'index-card',
    category: 'formatting',
    attributes: {
        mediaId: {
        ...
        title: {
            type: 'string',
            source: 'html',
            selector: '.cge-content-bloc-type-4-title'
        },
    },
    edit: (props) => {
        const {
            ...
            <div className={className + ' cge-bloc-container'}>
                <div className="alert alert-info alert-yellow">
                    <div className="cge-bloc-title">
                        <span className="title">CGE: Content - Bloc Type 4</span>
                    </div>
                    <div className="row">
                            ...
                            <div className="form-row">
                                <div className="col">
                                    <div className="form-group">
                                        ...
                                        <RichText
                                            className="cge-content-bloc-type-4-title"
                                            tagName="h2"
    ...
    save: (props) => {
        ...
        return (
            <div className={"block block-content__type4 uk-width-1-1 " + className}>
                <div className="block-content row">
                    <div className="block-text col-md-7 col-sm-6">
                        <RichText.Content
                            className="cge-content-bloc-type-4-title title"
                            tagName="h2"
                            value={title}
                        />
                    ...
                    <div className="block-image col-md-5 col-sm-6">
                        {
                            mediaUrl && (
                                <img width="503" height="392" src={mediaUrl} alt={mediaAlt}/>
                            )
                        }
                    </div>
                </div>
