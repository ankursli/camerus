...
<head>
    ...
    <link rel="preload" href="{{ get_template_directory_uri() . '/dist/fonts/icon.eot' }}" as="font" type="font/eot"
          crossorigin>
    <link rel="preload" href="{{ get_template_directory_uri() . '/dist/fonts/icon.woff' }}" as="font" type="font/woff"
          crossorigin>
    <link rel="preload" href="{{ get_template_directory_uri() . '/dist/fonts/icon.woff2' }}" as="font" type="font/woff2"
          crossorigin>
    <link rel="preload"
