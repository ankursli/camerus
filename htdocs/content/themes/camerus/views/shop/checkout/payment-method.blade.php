...
?>
<div class="card card-payment__method wc_payment_method payment_method_<?php echo esc_attr($gateway->id); ?>">
    <div class="card-header uk-flex  uk-accordion-title">
        <label class="name label-radio" for="payment_method_<?php echo esc_attr($gateway->id); ?>">
			...
			<span><?php echo $gateway->get_title(); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?> <?php echo $gateway->get_icon(); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></span>
        </label>
    </div><!-- .card-header -->
