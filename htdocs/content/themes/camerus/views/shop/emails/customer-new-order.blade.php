...
$msg_event = get_field('app_new_order_email_text_quotation', 'option');
$msg_dotation = get_field('app_new_order_email_text_dotation', 'option');
$msg_default = get_field('app_new_order_email_text_default', 'option');
?>
        ...
        <td width="768">
            ...
            <table id="identifiant" width="100%" cellpadding="0" cellspacing="0" border="0" summary=""
                ...
                <tr>
                    ...
                    <p><?php echo !empty($msg_event) ? $msg_event : __("Votre demande de devis a bien été envoyé. Nous reviendrons vers vous dans les plus brefs délais.", THEME_TD); ?></p>
                    <?php else : ?>
                    <?php if($product_type == 'dotation') : ?>
                    <p><?php echo !empty($msg_dotation) ? $msg_dotation : __("Merci pour votre commande. Nous reviendrons vers vous dans les plus brefs délais.", THEME_TD); ?></p>
                    <?php else : ?>
                    <p><?php echo !empty($msg_default) ? $msg_default : __("Merci pour votre demande. Nous vérifions les disponibilités du mobilier demandé et revenons vers vous sous 48 heures pour valider votre demande.",
                            THEME_TD); ?></p>
                    <?php endif; ?>
                    <?php endif; ?>
                </tr>
            ...
            <table cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                    <td><?php _e('Contact', THEME_TD); ?> :
                        <?php echo $order->get_meta('billing_genre'); ?> <?php echo $order->get_billing_first_name(); ?> <?php echo $order->get_billing_last_name(); ?></td>
                </tr>
                <tr>
