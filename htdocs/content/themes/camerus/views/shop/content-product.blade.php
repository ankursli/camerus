...
<div <?php wc_product_class('block block-product__link uk-width-1-3@m uk-width-1-2@s', $product); ?>>
    ...
    <div class="block-content"  data-product-info="<?php echo htmlspecialchars($json_data); ?>">
        <a class="block-header" href="<?php echo get_permalink($product->get_ID()) ?>"
           title="<?php _e('Réf', THEME_TD) ?>. <?php echo $product->get_sku(); ?>">
...
<div class="card card-suggestions__product">
    <div data-uk-spinner="ratio: 2"></div>
    <div class="card-content" data-product-info="<?php echo htmlspecialchars($json_data); ?>">
        <a class="card-header" href="<?php echo get_permalink($product->get_ID()) ?>"
           title="<?php _e('Réf', THEME_TD) ?>. <?php echo $product->get_sku() ?>">
